...
export default function Index({ eventCategories }) {
    const { data, meta } = eventCategories;
    ...
    const deleteCategory = (e) => {
        e.preventDefault();
        destroy(route('admin.event-categories.destroy', categoryToDelete.slug), {
    ...
    return (
        <>
            ...
            <div className="flex justify-between items-center mb-6">
                <h1 className="text-3xl font-bold text-smd-dark">Categorías de Eventos</h1>
                <Link href={route('admin.event-categories.create')} className="inline-flex items-center gap-2 bg-smd-soft-green text-white font-bold px-4 py-2 rounded-lg hover:bg-green-700">
                        ...
                        <tr key={category.id} className="border-b border-gray-200 hover:bg-gray-50">
                            ...
                            <td className="p-4">
                                <div className="flex gap-2">
                                    <Link href={route('admin.event-categories.edit', category.slug)} className="text-blue-600 hover:text-blue-900" title="Editar">
...
Index.layout = page => <AdminLayout children={page} title="Categorías de Eventos" />;

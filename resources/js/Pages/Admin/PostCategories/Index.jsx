...
export default function Index({ postCategories }) {
    const { data, meta } = postCategories;
    ...
    return (
        <>
            ...
            <div className="flex justify-between items-center mb-6">
                <h1 className="text-3xl font-bold text-smd-dark">Categorías de Posts</h1>
                <Link
                        ...
                        <tr key={category.id} className="border-b border-gray-200 hover:bg-gray-50">
                            ...
                            <td className="p-4">
                                <div className="flex gap-2">
                                    <Link href={route('admin.post-categories.edit', category.slug)} className="text-blue-600 hover:text-blue-900" title="Editar">

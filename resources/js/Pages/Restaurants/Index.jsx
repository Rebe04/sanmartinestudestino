        ...
        <MainLayout>
            <div className="min-h-screen w-full">
                <div className={`flex flex-col relative items-center justify-center pt-smd-104 w-full h-smd-496`} style={{ backgroundImage: `url(${blogImage})`, backgroundSize: 'cover'}}>
                    ...
                    <h1 className="text-smd-light text-center text-4xl lg:text-7xl font-second z-10">¿Donde Comer?</h1>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                        <aside>
                            <div className="bg-gray-200/80 rounded-xl mx-smd-24 lg:mx-0 p-smd-32 mb-smd-32">
                                <h2 className="text-2xl text-center lg:text-left font-second font-bold text-smd-dark mb-smd-16">¿Que Tipo de Comida uscabas?</h2>

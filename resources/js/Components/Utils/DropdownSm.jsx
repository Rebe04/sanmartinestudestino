...
const DropDownSmContext = createContext();
...
export default function DropdownSm({ title, children, mobile = false }) {
    ...
    return (
        ...
        <DropDownSmContext.Provider value={{isOpen, setIsOpen}}>
        ...
        </DropDownSmContext.Provider>
    );
};

const DropdownLink = ({ href, children }) => {
const { isOpen, setIsOpen } = useContext(DropDownSmContext);
    return(
        <div
